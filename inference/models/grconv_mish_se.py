...
from inference.models.grasp_model import GraspModel, ResidualBlockMish_SE
...
class GenerativeResnet(GraspModel):
    ...
    def __init__(self, input_channels=1, dropout=False, prob=0.0, channel_size=32):
        ...
        self.res1 = ResidualBlockMish_SE(128, 128)
        self.res2 = ResidualBlockMish_SE(128, 128)
        self.res3 = ResidualBlockMish_SE(128, 128)
        self.res4 = ResidualBlockMish_SE(128, 128)
        self.res5 = ResidualBlockMish_SE(128, 128)
