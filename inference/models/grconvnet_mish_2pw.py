...
from inference.models.grasp_model import GraspModel, ResidualBlockMish, ResidualBlock_sepa
...
class GenerativeResnet(GraspModel):
    ...
    def __init__(self, input_channels=1, dropout=False, prob=0.0, channel_size=32):
        ...
        self.res1 = ResidualBlockMish(128, 128)
        self.res2 = ResidualBlockMish(128, 128)
        self.res3 = ResidualBlock_sepa(128, 128)
        self.res4 = ResidualBlock_sepa(128, 128)
        self.res5 = ResidualBlock_sepa(128, 128)
