...
from inference.models.grasp_model import GraspModel, ResidualBlockMish,ori
...
class GenerativeResnet(GraspModel):
    ...
    def __init__(self, input_channels=1, dropout=False, prob=0.0, channel_size=32):
        ...
        self.res1 = ori(128, 128)
        self.res2 = ori(128, 128)
        self.res3 = ori(128, 128)
        self.res4 = ori(128, 128)
