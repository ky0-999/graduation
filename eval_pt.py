...
if __name__ == '__main__':
    args = parse_args()
    # net = get_network("graduation")
    # net.load_state_dict('/home/ericlab/gr_convnet/robotic-grasping/logs/OW_graduation2/epoch_92_iou_0.92.pt')

    # model_path='/home/ericlab/gr_convnet/robotic-grasping/logs/OW_graduation2/epoch_92_iou_0.92.pt'
    net = torch.jit.load('/home/ericlab/gr_convnet/robotic-grasping/logs/OW_graduation2/epoch_92_iou_0.92.pt')
    net.eval()
