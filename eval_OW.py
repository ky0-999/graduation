# python3 eval_OW.py --network /home/ericlab/gr_convnet/robotic-grasping/logs/OW_jacqurd/graduation/epoch_97_iou_0.91 --dataset jacquard --dataset-path /home/ericlab/jacquard_dataset --iou-eval 
#  python3 eval_OW.py --network   --dataset jacquard --dataset-path /home/ericlab/jacquard_dataset --iou-eval 
# 
import argparse
import logging
import time
...
from inference.models.graduation2 import GenerativeResnet
...
if __name__ == '__main__':
    ...
    split2 = int(np.floor(0.9 * test_dataset.length))
   
    if args.ds_shuffle:
        np.random.seed(args.random_seed)
        np.random.shuffle(indices)
    train_indices,val_indices,test_indices = indices[:split], indices[split:split2],indices[split2:]
    
       
    logging.info('Train size: {}'.format(len(train_indices)))
    logging.info('Val size: {}'.format(len(val_indices)))
    logging.info('Test size: {}'.format(len(test_indices)))
    ...
    for network in args.network:
        ...
        # net.load_state_dict(torch.load('/home/ericlab/gr_convnet/robotic-grasping/logs/OW_graduation2/epoch_92_iou_0.92'))
        # net.eval()
        # net = torch.load('/home/ericlab/gr_convnet/robotic-grasping/logs/OW_graduation2')
